    ...
    <div className='footer1-con'>
      <div className='footer1-wrap'>
        <div className='footer1'>
          <a href='/'>
            SAMSUNG Headset ,Ambrane Headset ,E-calorie Headset ,Philips Headset
            ,FD1 Headset ,DIZO Headset ,TCL Headset ,Bluetooth & Wired Headset
            ,Sennheiser Headset ,Skullcandy Headset ,WeCool Headset ,True
            Wireless Headset ,ROQ Headset ,Apple Headset ,Wefuse Headset ,realme
            Headset ,Toshiba Headset ,Motorola Headset ,Grostar Headset ,SYARA
            Headset
          </a>
          <h2>Buy Headphones Online at Flipkart</h2>
          &nbsp; &nbsp;
          <p>
