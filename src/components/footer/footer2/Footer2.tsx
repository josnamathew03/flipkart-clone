import Footer2List from './Footer2List'
import '../Footer.css'
import Footer2LastList from './Footer2LastList'
import FooterFootItems from './FooterFootItems'

const Footer2 = () => {
  return (
    <div>
      <div className='footer2-con'>
        <Footer2List
          head='ABOUT'
          items={[
            'Contact Us',
        ...
        <div className='footer2'>
          <div className='footer2-last'>
            ...
            />
            <div className='footer2-head'>Social</div>
            <div className='social-con'>
              ...
              <span>
                <img alt='' src='./youtube.svg' height='24' width='24'></img>
              </span>
              <span>
                <img alt='' src='./insta.svg' height='20' width='20'></img>
              </span>
            </div>
          </div>
      </div>
          ...
          <div className='footer2'>
            <div className='footer2-last footer2-last2'>
              <div className='footer2-head'>Registered Office Address:</div>
              <Footer2LastList
                items={[
                  'Flipkart Internet Private Limited, , ',
                  '  Buildings Alyssa, Begonia & ',
