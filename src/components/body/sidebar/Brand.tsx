  ...
  return (
    <div className='selected-container price-filter-con'>
      ...
      <div className='checkboxes-div'>
        ...
        <Checkboxes name='brand' value={'boat'} checked={false} label='boAt' />
        <Checkboxes name='brand' value={'oneplus'} checked={false} label='OnePlus' />
        <Checkboxes name='brand' value={'realme'} checked={false} label='realme' />
        <Checkboxes name='brand' value={'sony'} checked={false} label='SONY' />
        <Checkboxes name='brand' value={'cmf'} checked={false} label='CMF by Nothing' />
        <Checkboxes name='brand' value={'jbl'} checked={false} label='JBL' />
      </div>
